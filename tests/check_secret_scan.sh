...
#
# Scans git-tracked content and commit range. benchmarks/telemetry_sanitizer.py is the one
...
if git grep -nE 'sk-[a-zA-Z0-9-]{16,}' -- "$EXCLUDE" \
   | grep -vE 'sk-kimi-k3-master-secret-key-change-me|sk-kimi-k3-master-change-me|sk-kimi-k3-test-dev-|sk-kimi-k3-quota-test-|sk-kimi-k3-m5-check1|sk-iAOaud1mz1rx7uw0ZWeAaA'; then
